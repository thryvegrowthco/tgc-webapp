...
It opens **thryvegrowth.co/card**, a page made for people who scan your card. It shows your logo, photo, name and title, a **Book a free consultation** button, a **Save to contacts** button (it adds your name, title, email, website and photo to their phone's contacts), your email address, and links to your HR consulting and coaching pages. The page is hidden from Google on purpose, so it only reaches people who have your card or the link. Because cards are printed with this address, the **/card** page must always stay on the website, but what it says can change at any time without reprinting. Visits show up as **/card** in your website analytics, which is the simplest way to see how many people scanned. A consultation request that starts from the card looks the same as any other request.
