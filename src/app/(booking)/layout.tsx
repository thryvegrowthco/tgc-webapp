// Public booking route group — no auth, no marketing Header/Footer. A minimal
// branded shell so the client's "choose a time" experience feels personal and
// uncluttered. Renders inside the bare root layout.
