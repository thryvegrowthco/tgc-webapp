        ...
        <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-neutral-500 mt-1">
              Access your dashboard, bookings, and documents.
            </p>
          </div>
          ...
          {state.success ? (
            ...
            <form action={action} className="space-y-4">
              ...
              <p className="text-xs text-center text-neutral-400 leading-relaxed">
                ...
                <Link href="/terms" className="underline underline-offset-4 hover:text-neutral-600">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/privacy" className="underline underline-offset-4 hover:text-neutral-600">
                  Privacy Policy
                </Link>
                .
              </p>
