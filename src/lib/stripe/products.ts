...
export const SERVICES: Record<ServiceKey, ServiceProduct> = {
  ...
  coaching_package: {
    name: "Career & Leadership Coaching — 3-Session Package",
    description: "Three 60-minute 1:1 coaching sessions with Rachel.",
    amountCents: 40000,
  ...
  interview_package: {
    name: "Interview Preparation — 2-Session Package",
    description: "Two interview prep sessions — strategy + mock interview.",
    amountCents: 25000,
  ...
  resume_review: {
    name: "Resume Review",
    description: "Detailed written feedback on your existing resume.",
    amountCents: 7500,
  ...
  resume_rewrite: {
    ...
    description: "Complete resume rewrite with intake call and two revision rounds.",
    amountCents: 20000,
  ...
  job_alerts_monthly: {
    name: "Job Alerts & Watchlists — Monthly",
...
export const SERVICE_SELECT_OPTIONS = [
  ...
  { value: "coaching_package", label: "Career & Leadership Coaching — 3-Session Package ($400)" },
  { value: "interview_single", label: "Interview Preparation — Single Session ($100)" },
  { value: "interview_package", label: "Interview Preparation — 2-Session Package ($250)" },
  { value: "resume_review", label: "Resume Review ($75)" },
  { value: "resume_rewrite", label: "Full Resume Rewrite ($200)" },
  { value: "job_alerts_monthly", label: "Job Alerts & Watchlists ($50/month)" },
  { value: "hr_consulting_hourly", label: "HR Consulting — Hourly ($100/hr)" },
  { value: "hr_consulting_project", label: "HR Consulting — Project ($500+)" },
