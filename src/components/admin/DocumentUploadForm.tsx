...
const CATEGORIES = [
  ...
  { value: "deliverable", label: "Deliverable (notifies client)" },
  { value: "resume_rewrite", label: "Resume Rewrite (notifies client)" },
  { value: "hr_doc", label: "HR Document (notifies client)" },
